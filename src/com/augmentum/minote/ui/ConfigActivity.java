...
public class ConfigActivity extends Activity implements OnClickListener {
    ...
    private void initView() {
        ...
        noteDao = new NoteDaoImpl(ConfigActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.remind_me:
            ...
            setDate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (v.getId() == R.id.btn_set_date) {
                        ...
                        new DatePickerDialog(ConfigActivity.this, new OnDateSetListener() {
            ...
            AlertDialog.Builder ad = new Builder(ConfigActivity.this);
            ad.setTitle(TITLE);
            ad.setView(view);
            ad.setPositiveButton(SETTING, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    mAlarmManager = (AlarmManager) ConfigActivity.this.getSystemService(Service.ALARM_SERVICE);
                    Intent alertIntent = new Intent(ConfigActivity.this, AlarmReceiver.class);
                    alertIntent.putExtra("content", noteBg.getText().toString());
                    PendingIntent pi = PendingIntent.getBroadcast(ConfigActivity.this, 0, alertIntent,
        ...
        case R.id.delete_note:
            new AlertDialog.Builder(ConfigActivity.this).setTitle(DialogTitle.CONFIRM_DELETE)
        ...
        case R.id.add_desktop:
            ...
            Parcelable icon = Intent.ShortcutIconResource.fromContext(ConfigActivity.this, R.drawable.icon_one);
            ...
            if (!TextUtils.isEmpty(content)) {
                ...
                Intent in = new Intent(ConfigActivity.this, ConfigActivity.class);
                ...
                Toast.makeText(ConfigActivity.this, ToastConst.HAD_ADDED, Toast.LENGTH_SHORT).show();
            }
            break;

        case R.id.share:
            AlertDialog.Builder ab = new Builder(ConfigActivity.this);
            ...
            ab.setItems(s, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (0 == which) {
                        ...
                        ConfigActivity.this.startActivity(Intent.createChooser(mail, "选择要使用的应用"));
                    }
    ...
    public void onBackPressed() {
        ...
        resp.putExtra("item_id",(int)rowId );
